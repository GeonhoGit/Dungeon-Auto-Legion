...
const unitAbilities = {
  warrior: {
    ...
    awakenedSkill: { name: "진·방패 강타", description: "공격 시 45% 확률로 방패를 강하게 내리찍어 공격력의 175% 피해를 주고, 3초 동안 대상의 공격속도를 40%, 5초 동안 방어력을 25% 크게 감소시킵니다. (재사용 대기시간 2초)" },
  ...
  guardian: {
    ...
    awakenedSkill: { name: "성역의 의지", description: "피격 시 35% 확률로 성스러운 빛이 몸을 감싸며 잃었던 최대 체력의 10%를 즉시 회복합니다. 굳건한 방어로 전열을 유지합니다." },
  ...
  mage: {
    ...
    awakenedSkill: { name: "메테오 스트라이크", description: "공격 4회마다 하늘에서 거대한 운석을 소환하여 전장의 '모든 적'에게 공격력의 120% 피해를 입히고, 3초간 매초 최대 체력의 2%에 해당하는 강력한 화상 피해를 줍니다." },
  ...
  archer: {
    ...
    awakenedSkill: { name: "폭풍 사격", description: "공격 시 40% 확률로 맹렬한 폭풍 같은 화살을 연사해 같은 대상에게 공격력의 80% 추가 피해를 주고, 3초 동안 대상의 현재 체력의 15%에 달하는 치명적인 출혈 피해를 입힙니다." },
  ...
  rogue: {
    ...
    awakenedSkill: { name: "그림자 습격", description: "공격 시 35% 확률로 그림자 속에서 은밀하고 치명적인 일격을 가해, 공격력의 220%에 달하는 엄청난 치명타 피해를 줍니다." },
  ...
  healer: {
    ...
    awakenedSkill: { name: "찬란한 광휘", description: "공격 2회마다 눈부신 생명의 빛을 뿜어내어, 현재 체력 비율이 가장 낮은 아군 1명을 (치유사 공격력의 250% + 대상 최대 체력의 10%)만큼 대폭 회복시킵니다." },
  ...
  necromancer: {
    ...
    awakenedSkill: { name: "군단 소환", description: "공격 4회마다 기본 스탯(체력/공격력 30%, 방어력 15, 공속 20%)이 대폭 강화된 '해골 병사' 1마리를 소환합니다. (최대 2마리 유지) 공격 시 10% 확률로 대상을 중독시킵니다." },
  ...
  bard: {
    ...
    awakenedSkill: { name: "전설의 서사시", description: "공격 3회마다 전장을 뒤흔드는 전설적인 연주를 시작하여, 가장 공격력이 높은 핵심 아군 1명의 공격력을 4초간 80% 폭발적으로 증가시킵니다." },
  ...
  witch: {
    ...
    awakenedSkill: { name: "진·맹독 물약", description: "공격 2회마다 끔찍한 맹독을 투척해 대상의 최대 체력을 1% 영구히 부식시키고, 그만큼 자신의 최대 체력과 공격력을 한계 없이 폭발적으로 증가시킵니다." },
